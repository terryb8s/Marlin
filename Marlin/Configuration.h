...
#define CUSTOM_MENDEL_NAME "MDFStrap"

// Define this to set a unique identifier for this printer, (Used by some programs to differentiate between machines)
// You can use an online service to generate a random UUID. (eg http://www.uuidgenerator.net/version4)
#define MACHINE_UUID "00000000-0000-0000-A001-000000000000"
...
//    You must specify the X & Y coordinates of all 3 points
  ...
  #define Z_PROBE_OFFSET_FROM_EXTRUDER -20.6
...
// Latest green was 808.5 change to see if better results

#define DEFAULT_AXIS_STEPS_PER_UNIT   {100.32,100.65,2561.9,800}  // default steps per unit for Ultimaker
...
#define ABS_PREHEAT_HPB_TEMP 81
...
#define SERVO_ENDSTOP_ANGLES {0,0, 0,0, 88,180} // X,Y,Z Axis Extend and Retract angles
